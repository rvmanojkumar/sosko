                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="d-flex align-items-center">
                                                @if($attribute->type == 'color')
                                                    <div class="color-swatch" style="width: 30px; height: 30px; background: {{ $value->color_code ?? '#ccc' }}; border-radius: 50%; margin-right: 10px; border: 1px solid #ddd;"></div>
                                                @endif
